...
var REFRESH_KEY = "rm_refresh_token";
var USER_KEY = "rm_user";
var AuthService = class _AuthService {
  constructor(http, router) {
    this.http = http;
    this.router = router;
    this.base = `${environment.apiUrl}/api/auth`;
  }
  ...
  refreshToken() {
    ...
    return this.http.post(`${this.base}/refresh`, { refreshToken }).pipe(tap((res) => {
      localStorage.setItem(TOKEN_KEY, res.token);
    }));
  }
  getToken() {
...
@angular/router/fesm2022/router.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-LPBYNUC6.js.map
